...
export class BagService {
    ...
    public async findAll(): Promise<Bag[]> {
    ...
    public async createOne(bag: BagDto): Promise<Bag> {
    ...
    public async updateOne(bag: BagDto): Promise<Bag> {
    ...
    public async deleteOne(id: string): Promise<Bag> {
